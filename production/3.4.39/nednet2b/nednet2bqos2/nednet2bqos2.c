...
String gVersion = "nednet2bqos2_3.2-41";
...
int main(int argc, char **argv) {
    ...
    printf("nednet2bqos2 version=%s\n", gVersion);
    
    if (argc > 1) {
        printf("nednet2bqos2 entering argc handling.\n");
    ...
    GetUciConfig();
    if (!sEnabled) {
        printf("nednet2bqos2: Not enabled.\n");
        return 0;
    }
    
    // Delay and the read MAC
    printf("nednet2bqos2: sleep then macread\n");
    sleep(10);
    MacRead();
