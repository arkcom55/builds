...
config_t* _conf_parseConfig(int config_file_fd);
...
void conf_setValue(config_t **start,
    const char* var,
    const char* val,
    const char* section
);

config_t* _conf_getValue(config_t *start,
    const char* section,
    const char* var,
    char**      dest
);
